...
call configure.bat -prefix C:\Qt\5.6.3-Static\ -opensource -confirm-license^
 -debug -static -static-runtime -nomake examples -nomake tests -target xp -mp -no-pch^
...
cd /d C:\Qt
7z a -t7z -m0=lzma -mx=9 -mfb=64 -md=32m -ms=on -sse Qt-5.6.3-XP-Static-Debug.7z 5.6.3-Static